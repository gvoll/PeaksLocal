...
const glossary = [
  { term: 'Entity', def: 'How a search engine or AI system understands a business as a distinct, real-world thing — not just a keyword match.' },
  { term: 'Knowledge Graph', def: 'A database Google and other platforms use to store verified facts about businesses, people, and places. Getting your business into it improves recommendation accuracy.' },
  { term: 'LocalBusiness Schema', def: 'A specific type of structured data markup that tells search engines exactly what kind of business you are, where you\'re located, and how to reach you.' },
  { term: 'Citation', def: 'Any online mention of your business name, address, and phone number — on directories, review sites, or industry listings. Consistent citations build platform trust.' },
  { term: 'Review Recency', def: 'How recently you\'ve received reviews. Platforms weight recent reviews more heavily than older ones — a steady stream matters more than a one-time burst.' },
  { term: 'Trust Signal', def: 'Any verified data point that tells a platform your business is real and reliable — a claimed profile, a consistent NAP, a review response, or a schema tag.' },
  { term: 'Profile Drift', def: 'The gradual degradation of your business information across platforms as details go out of date, data aggregators push stale records, or new platforms go unclaimed.' },
];
