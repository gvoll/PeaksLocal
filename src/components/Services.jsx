          ...
          >
            ...
            <div className="services-card reveal" style={{ flex: 1 }}>
              <div style={{
                ...
                <span style={{ display: 'inline-block', background: 'rgba(255,255,255,0.15)', color: 'var(--white)', fontFamily: "'DM Mono', monospace", fontSize: '0.6rem', letterSpacing: '0.1em', textTransform: 'uppercase', padding: '4px 10px', borderRadius: '3px', marginBottom: '14px' }}>
                  ONE-TIME PROJECT
                </span>
                <h3 style={{
                  fontFamily: "'Barlow Condensed', sans-serif",
